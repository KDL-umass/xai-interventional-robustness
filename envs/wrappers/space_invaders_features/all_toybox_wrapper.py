...
class ToyboxEnvironment(GymEnvironment):
    def __init__(self, name, custom_wrapper: SpaceInvadersResetWrapper=SpaceInvadersResetWrapper, *args, **kwargs):
    ...
    def duplicate(self, n):
        return DuplicateEnvironment([
            ToyboxEnvironment(self._name, *self._args, **self._kwargs) for _ in range(n)
        ])