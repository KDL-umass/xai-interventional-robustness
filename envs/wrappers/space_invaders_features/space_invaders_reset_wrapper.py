...
class SpaceInvadersResetWrapper(gym.Wrapper): 
    ...
    def __init__(self, tbenv: SpaceInvadersEnv, intv: int, lives: int):
        ...
        self.env = tbenv
        self.toybox = tbenv.toybox          # Why does this fail when ToyboxBaseEnv has a toybox attribute? 
    ...
    def on_episode_start(self): 
        ...
        # Get JSON state 
        if self.intv >= 0:
            with open('interventions/intervention_states/intervened_state_'+str(self.intv)+'.json') as f: 
